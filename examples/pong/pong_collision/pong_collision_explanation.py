...
for i in range(12):
    x = start_pos[0] + (0 if i % 2 == 0 else step)
...
while run:
    ...
    if current_i > 2:
        pygame.draw.lines(window, (228, 0, 0), False, pos_list[2:min(14, current_i+1)], 3)
    if current_i > 13:
        pygame.draw.lines(window, (0, 196, 0), False, pos_list[13:current_i+1], 3)
    current_i += 1
